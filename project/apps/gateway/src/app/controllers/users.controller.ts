...
export class UsersController {
  ...
  public async changePassword(@Body() changePasswordDto: ChangePasswordDto, @UserId() currentUserId: string) {
    const {data} = await this.httpService.axiosRef.patch(`${ApplicationServiceURL.Users}/password/change`, {...changePasswordDto, currentUserId});
